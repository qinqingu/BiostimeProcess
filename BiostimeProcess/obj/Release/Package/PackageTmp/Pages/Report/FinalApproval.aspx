<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="_ReportLayout.Master" CodeBehind="FinalApproval.aspx.cs" Inherits="BiostimeProcess.Pages.Report.FinalApproval" %>

<%@ MasterType VirtualPath="_ReportLayout.master" %>
    ...
    <script type="text/javascript" language="javascript">
        $(document).ready(function () {
            ...
            $submitProcessButton.add($returnPrevStepButton).add($returnStartorButton).click(function () {
                return webui.faReportProcess.submitValidate();
            });
        });
    </script>
</asp:Content>
