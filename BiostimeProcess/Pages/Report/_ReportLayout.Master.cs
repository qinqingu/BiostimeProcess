...
{
    public partial class _BaogaoLayout : MasterPageBase
    {
        private readonly FaReportInfoJsonService _faReportInfoJsonService = new FaReportInfoJsonService();
        private readonly ProcessFormService _formService = new ProcessFormService();
        ...
        public FaProcessStepEnum Step
        {
            set
            {
                try
                {
                    ...
                    FaReportDetailsControl.Step = value;
                    InitControls(value);
                }
                catch (Exception ex)
                {
        ...
        private void InitControls(FaProcessStepEnum value)
        {
            if (value != FaProcessStepEnum.Start)
            {
                ...
                foreach (object control in FaReportDetailsControl.Controls)
                {
        ...
        public IList<FaProcess> GetFaProcess()
        {
            ...
            return _faReportInfoJsonService.GetFaArchiveInfos(json);
        }
