...
{
    public partial class _VoucherLayout : MasterPageBase
    {
        ...
        public FaProcessStepEnum Step
        {
            set
            {
                try
                {
                    ...
                    FaVoucherDetailsControl.Step = value;
                    InitControls(value);
                }
                catch (Exception ex)
                {
        ...
        private void InitControls(FaProcessStepEnum value)
        {
            if (value != FaProcessStepEnum.Start)
            {
                ...
                foreach (object control in FaVoucherDetailsControl.Controls)
                {
