<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FaVoucherDetails.ascx.cs" Inherits="BiostimeProcess.UserControls.FaArchiveDetails" %>
...
<script language="javascript" type="text/javascript">
    $(document).ready(function () {
        webui.faVoucherInfodetails.initialize({
